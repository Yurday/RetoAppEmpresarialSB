...
public class UseCaseRestVote {
    ...
    @Autowired
    public UseCaseRestVote(AnswerRepository answerRepository, AnswerMapper answerMapper, UserRepository userRepository, UserMapper userMapper, MensajeMapper mensajeMapper) {
    ...
    public Mono<MensajeDTO> restPosition(String answerId, String userId) {
                ...
                .flatMap(response ->{
                    if(response.getUserId() == null){
                        ...
                        return userRepository
                                ...
                                .flatMap( user -> restar(answerId)).map(mensajeMapper.votar("Voto restado"));
                    }
    ...
    public Mono<AnswerDTO> restar(String answerId) {
